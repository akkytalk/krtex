          ...
          <ul className="navbar-nav d-flex align-items-center">
            ...
            <li className="nav-item d-none d-sm-inline-block ml-2">
              ...
              >
                ...
                <Typography color="textPrimary">LCMaster</Typography>
              </Breadcrumbs>
            </li>
          </ul>
          {/* SEARCH FORM */}
              ...
              <Card>
                <CardHeader className="bg-warning text-white">
                  ...
                  <Modal
                    ...
                    toggle={toggle}
                  >
                    <ModalHeader toggle={toggle}>Add New LCMaster</ModalHeader>
                    <ModalBody>
                      <form
                        onSubmit={(event) => {
...
export default connect(mapStateToProps, mapDispatchToProps)(LCMaster);
